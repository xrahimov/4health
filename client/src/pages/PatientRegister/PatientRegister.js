...
import { addPatient } from '../../store/actions/patientActions';
...
import BirthdayPicker, { StyledPickerContainer } from './BirthdayPicker';
import requireUser from '../../hoc/requireUser';

const PatientRegister = ({ patient: { isLoading, error }, history, addPatient }) => {
  // form states
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      addPatient(values, history);
    },
  });

  return (
    <Layout>
      <StyledTitle>Мижозни рўйҳатдан ўтказиш</StyledTitle>
      <StyledRegister>
        <RegisterContainer>
...
export default compose(
  requireUser,
  withRouter,
  connect(mapStateToProps, { addPatient }),
)(PatientRegister);
